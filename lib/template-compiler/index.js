...
module.exports = function(html) {
    ...
    var compile =
        isServer && compiler.ssrCompile && vueOptions.optimizeSSR !== false ? compiler.ssrCompile : compiler.compile;

    var compiled = compile(html, compilerOptions);

    // for mp => *.wxml
    compileWxml.call(this, compiled, html).then(() => {
        // tips
        ...
        if (compiled.errors && compiled.errors.length) {
            ...
            if (
                !isProduction &&
                (!bubleOptions || !bubleOptions.transforms || bubleOptions.transforms.stripWith !== false)
            ) {
